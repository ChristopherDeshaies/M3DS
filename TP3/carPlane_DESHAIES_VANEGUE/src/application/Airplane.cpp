...
void Airplane::drawWorld() {
 ...
 // p3d::modelviewMatrix.rotate(_angleZ,0,0,1); // roll
  p3d::modelviewMatrix.rotate(_orientation); //q13
...
void Airplane::move() {
    ...
    Vector3 uneDirection = _orientation * Vector3(0.0,0.0,_velocity);
    _position = _position + uneDirection;
}

void Airplane::pitchDown() {
  //_angleX+=_increment;
  _orientation.rotate(_increment,Vector3(1,0,0)); //q13
}
...
void Airplane::rollRight() {
  //_angleZ+=_increment;
  _orientation.rotate(_increment,Vector3(0,0,1)); //q13
}
...
void Airplane::yawLeft() {
  //_angleY+=_increment;
  _orientation.rotate(_increment,Vector3(0,1,0)); //q13
}
